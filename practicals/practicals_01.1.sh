...
# ln -s $SCRIPT_DIR/../../training_data/$fastq_dir .

# ref_dir="toy_mouse_ref"
# ln -s $SCRIPT_DIR/../../training_data/$ref_dir .
...
# # Convert to data to anndata format
# conda activate $conda_sc
...
# # For exercises, we use the product of alevin_fry_quant (without the removal of empty drops)
# workdir = "/homes/irisyu/training/scrnaseq_python_2023/ex2_xmpl_run"
# adata = sc.read(f"{workdir}/alevin_fry_quant/")
# adata